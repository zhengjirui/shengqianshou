...
public class KindDetailActivity extends BaseNormalTitleActivity implements View.OnClickListener, OnItemClick {
    //轮播图
    ...
    private void getData() {
        ...
        if (Utils.isNetworkAvailable(this)) {
            ...
            Network.getInstance().getApi(HomeApi.class)
                    ...
                    .subscribe(new NetResultHandler<HomeSearchResultBean>(KindDetailActivity.this) {
                        @Override
...
//            Utils.show(mContext, "亲!已经到底了");
        ...
        if (page == 1) {
            if (mAdapter == null) {
                mAdapter = new CommonRecyclerAdapter(KindDetailActivity.this, R.layout.item_program_product, mProductList) {
                    @Override
                    public void convert(ViewHolderRecycler viewHolder, Object data) {
                        try {
                            ...
                            Glide.with(KindDetailActivity.this).load(bean.imgs)
                                    .placeholder(R.drawable.ic_home_default)
                                    .bitmapTransform(new RoundedCornersTransformation(KindDetailActivity.this, UtilsDpAndPx.dip2px(KindDetailActivity.this, 5), 0)).into(img);
                            //原件
                ...
                mLayoutManager = new GridLayoutManager(KindDetailActivity.this, 2);
                mLayoutManager.setSmoothScrollbarEnabled(true);

                rvProduct.addItemDecoration(new GridItemDecoration(
                        new GridItemDecoration.Builder(KindDetailActivity.this)
                                .margin(4, 4)
                                .horSize(16)
                                .verSize(16)
