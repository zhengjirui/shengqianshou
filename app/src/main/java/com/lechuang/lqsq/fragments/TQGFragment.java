...
public class TQGFragment extends LazyBaseFragment implements OnItemClick {
    ...
    protected void initView(View root) {
        super.initView(root);
        mAdapter = new CommonRecyclerAdapter(getContext(), R.layout.tqg_item, list) {
            @Override
            public void convert(ViewHolderRecycler holder, Object o) {
                ...
                holder.getView(R.id.jifen_num).setVisibility(TextUtils.isEmpty(bean.zhuanMoney) ||
                        !UserHelper.isLogin() ||
                ...
                holder.setText(R.id.quan_num, bean.couponMoney + "券");
